...
const translations = {
  pt: {
    ...
    'hero.career': 'Carreira',
    'hero.frontend': 'Frontend',
    'hero.backend': 'Backend',
    'hero.devops': 'DevOps',
    'hero.expert': 'Expert',
    'hero.advanced': 'Avançado',
    'hero.proficient': 'Proficiente',
    'hero.learning': 'Aprendendo',
    'hero.yearsExp': 'Anos de Experiência',
    'hero.projectsCompleted': 'Projetos Concluídos',
